...
<c:if test="${vo ne null}">
	<div id="bbs">
	<%--enc_type이 없고 post만 던져질때 content타입이 application으로 지정된다.--%>
	...
	encType="multipart/form-data">
		<table summary="게시판 글수정">
			...
			<tbody>
				...
				<tr>
					<th>제목:</th>
					<td><input type="text" name="title" id="title" size="45" value="${vo.subject}"/></td>
				</tr>
				<tr>
					<th>이름:</th>
					<td><input type="text" name="writer" id="write" size="12" value="${vo.writer}"
					readonly/></td>
				</tr>
				<tr>
					<th>내용:</th>
